...
namespace Operating_System_Kernel
{
    class Super_Block
    {
        ...
        public static byte s_inodes_count=100;
        // i-nod-eri qanak,fayleri maximum qanak
        public static int Count_Of_Blocks = 102400;//..fayleri qanak * et faylum maximum blockneri qanak

        public static byte s_log_block_size = 1;//Индикатор размера логического блока: 0 = 1 Кб; 1 = 2 Кб; 2 = 4 Кб	 
